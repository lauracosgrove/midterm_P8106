...
We built predictive models on the training data using 6 methods: stepwise linear regression, Lasso, Ridge, PCR, GAM, and MARS. All model builds were performed using the `caret` package; for lasso, ridge, and MARS, the lamdba selected by `caret` was used. The optimal model was selected based on training RMSE, and models were again compared based on training RMSE. All R code used in this project is provided in the Appendix.
...
>>>>>>> 7f5eeaf0193cfcf6612b0f94e76996f22908eef4
```
