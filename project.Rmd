...
Variable importance was relatively consistent through each model, as measured by loss-perturbed RMSE in the `caret` cross-validation and shown in Appendix [FIGURE BLANK]. However, compared to other models, GAM gave much more weight to the value of the geography-related factor variables Metro and Metro Adjacency. 
